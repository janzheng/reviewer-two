...
// import { OAUTH_GITHUB_ID, OAUTH_GITHUB_SECRET } from "$env/static/private"

// export const svelteKitAuth = SvelteKitAuth({
//   providers: [
//     GitHub({ clientId: OAUTH_GITHUB_ID, clientSecret: OAUTH_GITHUB_SECRET })
//   ]
// })
...
export async function cookieHandler({ event, resolve }) {
...
// export const handle = sequence(svelteKitAuth, cookieHandler);
export const handle = sequence(cookieHandler);